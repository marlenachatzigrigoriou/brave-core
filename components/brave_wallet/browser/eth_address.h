...
#ifndef BRAVE_COMPONENTS_BRAVE_WALLET_ETH_ADDR_RESS_H_
#define BRAVE_COMPONENTS_BRAVE_WALLET_ETH_ADDR_RESS_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_WALLET_ETH_ADDR_RESS_H_
